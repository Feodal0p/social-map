    ...
    public function run(): void
    {
        ...
        $event1 = Event::firstOrCreate(
            ...
            [
                ...
                'location' => [
                    ...
                    'country' => 'Україна',
                    'display_name' => 'вулиця Test 1337, Луцьк, Волинська область, Україна',
                ],
                'latitude' => 50.747231,
        ...
        $event2 = Event::firstOrCreate(
            ...
            [
                ...
                'location' => [
                    ...
                    'state' => 'Волинська область',
                    'country' => 'Україна',
                    'display_name' => 'вулиця Test 228, Луцьк, Волинська область, Україна',
                ],
                'latitude' => 50.717231,
        ...
        $event3 = Event::firstOrCreate(
            ...
            [
                ...
                'location' => [
                    'road' => 'вулиця Test',
                    'house_number' => 'Хочу ножика в кс',
                    'locality' => 'Луцьк',
                    'state' => 'Волинська область',
                    'country' => 'Україна',
                    'display_name' => 'вулиця Test Хочу ножика в кс, Луцьк, Волинська область, Україна',
                ],
                'latitude' => 50.757231,
